    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-700 to-indigo-800 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-purple-200 mt-2">Continue learning today</p>
        </div>
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            Don&apos;t have an account? <Link to="/register" className="text-purple-600 font-semibold hover:underline">Sign up</Link>
          </p>
        </div>
      </motion.div>
    </div>
